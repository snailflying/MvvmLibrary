 ...
 * @Date 2019-06-22
 * @Description 自定义 Toast 辅助类
 */
internal class ToastHelper(// 当前的吐司对象
            ...
            */
            ...
            try {
                ...
                sendEmptyMessageDelayed(
                    0, (if (mToast.duration == Toast.LENGTH_LONG)
                        ToastHandler.LONG_DURATION_TIMEOUT
                    else
                        ToastHandler.SHORT_DURATION_TIMEOUT).toLong()
                )
    ...
    fun cancel() {
        ...
        if (isShow) {
            try {
                ...
                mWindowHelper.windowManager.removeView(mToast.view)
            } catch (ignored: NullPointerException) {
